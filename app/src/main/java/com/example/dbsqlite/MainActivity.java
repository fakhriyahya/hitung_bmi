...
public class MainActivity extends AppCompatActivity {
        ...
        public void LoginFunction() {
            if (EditTextEmptyHolder) {
                ...
                builder.setMessage("Masukkan Nama Pengguna dan Password").setNegativeButton("OK", null).create().show();
            }
        }
        ...
        public void CheckFinalResult() {
            if (TempPassword.equalsIgnoreCase(PasswordHolder)) {
                ...
                //Messages Pop Up
                AlertDialog.Builder builder = new AlertDialog.Builder(MainActivity.this);
                builder.setMessage("Nama Pengguna Belum Terdaftar, Silahkan Lakukan Daftar Terlebihdahulu").setNegativeButton("OK", null).create().show();
            }
