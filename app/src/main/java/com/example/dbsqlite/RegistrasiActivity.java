...
public class RegistrasiActivity extends AppCompatActivity {
    ...
    public void SQLiteTableBuild() {
        sqLiteDatabaseObj.execSQL("CREATE TABLE IF NOT EXISTS " + SQLiteHelper.TABLE_NAME + "(" +
                ...
                SQLiteHelper.Table_Column_1_Email + " VARCHAR, " +
                SQLiteHelper.Table_Column_2_Password + " VARCHAR);");
    }
    ...
    public void InsertDataIntoSQLiteDatabase(){
        if(EditTextEmptyHolder == true) {
            ...
            builder.setMessage("Regristasi Sukses").setNegativeButton("OK",null).create().show();
        }
        else {
            // Messages Pop Up
            AlertDialog.Builder builder = new AlertDialog.Builder(RegistrasiActivity.this);
            builder.setMessage("Mohon Mengisi Semua Kolom").setNegativeButton("OK",null).create().show();
        }
    }
    ...
    public void CheckingEmailAlreadyExistsOrNot(){
        ...
        cursor = sqLiteDatabaseObj.query(SQLiteHelper.TABLE_NAME, null, " " +
                SQLiteHelper.Table_Column_1_Email + "=?", new String[]{EmailHolder}, null, null, null);
